            ...
            <div className="space-y-4">
                {tasks.length === 0 ? (
                    ...
                    tasks.map((task, index) => {
                        ...
                        // Current logic: First task that isn't past, OR just the first task if everything is future/null
                        const isCurrent = !isPast && (index === 0 || (index > 0 && tasks[index - 1].endTime && new Date(tasks[index - 1].endTime || '') < new Date()));
                        ...
                        return (
                            <div
                                ...
                                className={cn(
                                    "group relative cursor-pointer transition-all duration-700 ease-out", // Slower transition
                            ...
                            >
                                ...
                                <span className={cn(
                                    ...
                                    isCurrent && "animate-pulse-slow" // Pulse dot
                                )} />
                                ...
                                <div className={cn(
                                    ...
                                    index % 3 === 0 ? "bg-[oklch(0.98_0.01_350)] dark:bg-[oklch(0.2_0.02_350)]" :
                                        index % 3 === 1 ? "bg-[oklch(0.98_0.01_160)] dark:bg-[oklch(0.2_0.02_160)]" :
                                            "bg-[oklch(0.98_0.01_240)] dark:bg-[oklch(0.2_0.02_240)]",
                                    isCurrent && "ring-2 ring-primary/30 shadow-lg scale-[1.01]"
                                )}>
